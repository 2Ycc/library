...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (2, '数据报表', '/dashbord', 'el-icon-s-marketing', '11', NULL, 'admin/Dashbord', 100);
INSERT INTO `sys_menu` VALUES (4, '系统管理', NULL, 'el-icon-s-grid', NULL, NULL, NULL, 900);
INSERT INTO `sys_menu` VALUES (5, '用户管理', '/user', 'el-icon-user', NULL, 4, 'admin/User', 901);
INSERT INTO `sys_menu` VALUES (6, '角色管理', '/role', 'el-icon-s-custom', NULL, 4, 'admin/Role', 902);
INSERT INTO `sys_menu` VALUES (7, '菜单管理', '/menu', 'el-icon-menu', NULL, 4, 'admin/Menu', 903);
INSERT INTO `sys_menu` VALUES (8, '文件管理', '/file', 'el-icon-document', NULL, 4, 'admin/File', 904);
...
INSERT INTO `sys_menu` VALUES (41, '读者管理', '/reader', 'el-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solidel-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solid\r\nel-icon-user-solid', '读者管理', NULL, 'admin/Reader', 200);
INSERT INTO `sys_menu` VALUES (42, '所有借阅记录', '/record', 'el-icon-s-order', '管理员查询所有借阅记录', NULL, 'admin/Record', 300);
...
CREATE TABLE `sys_user`  (
  ...
  `credit` tinyint NULL DEFAULT 100 COMMENT '信用积分：\r\n1、初始为100分，上限为100分；\r\n2、逾期一次扣10分；\r\n3、低于80分禁止借书；\r\n4、每个月的1号恢复10分；\r\n5、还书一次加5分。',
  `baned` tinyint NULL DEFAULT 0 COMMENT '是否被禁用：0-未被禁用 1-被禁用',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `t_book` VALUES (10, '测试', '1111111111111', '熊猫', '出版社', '2022-03-16', '2022-03-17 15:16:24', '3', 1, 'http://localhost:9090/file/ba2e0c9866ca499a93eaf06b7c618c0d.jpg', 12);
...
CREATE TABLE `t_record`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '借书记录id',
...
INSERT INTO `t_record` VALUES (12, 30, 10, '2022-04-07', '2022-06-07', '2022-04-07 13:57:54', 1, 0, '2022-04-07 14:00:31');
INSERT INTO `t_record` VALUES (13, 30, 10, '2022-04-07', '2022-06-07', '2022-04-07 14:02:41', 0, 0, NULL);
